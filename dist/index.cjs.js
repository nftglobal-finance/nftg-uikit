...
var Icon$1o = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 256 256" }, props),
        React__default['default'].createElement("image", { width: 256, height: 256, href: "/images/custom/nftg-token.png" })));
};

var Logo$2 = function (_a) {
    _a.isDark; var props = __rest(_a, ["isDark"]);
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 640 212" }, props),
        React__default['default'].createElement("image", { width: 640, height: 212, href: "/images/custom/logo-text.png" })));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://nftglobal.finance/swap?outputCurrency=0x76f6cd75ce81e88916f8d933ab76efe18ced6ad3", target: "_blank" },
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#ff6a6a", background: "#08060B", backgroundDisabled: "#3c3742", backgroundAlt: "#0D0D0D", backgroundAlt2: "rgba(39, 38, 44, 0.7)", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#000000", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#353547", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#B8ADD2", disabled: "#524B63", gradients: {
...
var socials = [
    {
        label: "Twitter",
        icon: "Twitter",
        href: "https://twitter.com/NFT_Globall",
    },
    {
        label: "Telegram",
        icon: "Telegram",
        href: "https://t.me/NFT_Globall"
    },
    // {
    //   label: "Reddit",
    //   icon: "Reddit",
    ...
    // },
    {
        label: "Github",
        icon: "Github",
        href: "https://github.com/nftglobal-finance/",
    },
];
        ...
        React__default['default'].createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            React__default['default'].createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default['default'].createElement(Flex, { order: [1, null, 2], mb: ["5px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default['default'].createElement(Button, { as: "a", href: "https://nftglobal.finance/swap?outputCurrency=0x76f6cd75ce81e88916f8d933ab76efe18ced6ad3", target: "_blank", scale: "sm", endIcon: React__default['default'].createElement(Icon$23, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
